...
public class LineFactory : MonoBehaviour
{
	...
	private ActiveBall _activeBall;
	...
	void Start ()
	{
		...
		_activeBall = ActiveBall.Instance;
	}
	...
	private void CreateNewLine ()
	{
		...
		currentLine.GetComponent<LineRenderer>().colorGradient = _activeBall.ActiveLineObject.gradient;
